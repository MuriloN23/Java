...
public class Pers_Reembolsos extends ArrayList<Reembolso> {
	private static final long serialVersionUID = 1L;

	public void readFile() {
		try {
			FileInputStream fis = new FileInputStream("Reembolsos.bin");
	...
	public void saveFile() {
		try {
			FileOutputStream fos = new FileOutputStream("Reembolsos.bin");
