...
public class App {
	...
	public static void init() {
		int opcao;
		Pers_Clientes clientes = new Pers_Clientes();
		Pers_Imoveis imoveis = new Pers_Imoveis();
		Pers_Faturas faturas = new Pers_Faturas();
		Pers_Pagamentos pagamentos = new Pers_Pagamentos();
		Pers_Reembolsos reembolsos = new Pers_Reembolsos();
	...
	protected static void menuClientes(Pers_Clientes clientes) {
		int opcao;
	...
	protected static void menuImoveis(Pers_Imoveis imoveis, Pers_Clientes clientes) {
		int opcao;
	...
	protected static void menuFaturamento(Pers_Imoveis imoveis, Pers_Faturas faturas, Pers_Pagamentos pagamentos, Pers_Reembolsos reembolsos) {
		int opcao;
