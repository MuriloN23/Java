...
public class Pers_Pagamentos extends ArrayList<Pagamento> {
	private static final long serialVersionUID = 1L;
	
	public void readFile() {
		try {
			FileInputStream fis = new FileInputStream("Pagamentos.bin");
	...
	public void saveFile() {
		try {
			FileOutputStream fos = new FileOutputStream("Pagamentos.bin");
	...
	public void createPagamento(Fatura fatura, Pers_Reembolsos reembolsos) throws Exception {
