...
public class Pers_Imoveis extends ArrayList<Imovel> {
	private static final long serialVersionUID = 1L;
	
	public void readFile() {
		try {
			FileInputStream fis = new FileInputStream("Imoveis.bin");
	...
	public void saveFile() {
		try {
			FileOutputStream fos = new FileOutputStream("Imoveis.bin");
	...
	public void editarImovel(Pers_Clientes clientes) throws Exception {
		Utilitarios.limpaTela();
