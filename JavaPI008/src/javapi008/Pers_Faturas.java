...
public class Pers_Faturas extends ArrayList<Fatura> {
	private static final long serialVersionUID = 1L;

	public void readFile() {
		try {
			FileInputStream fis = new FileInputStream("Faturas.bin");
	...
	public void saveFile() {
		try {
			FileOutputStream fos = new FileOutputStream("Faturas.bin");
	...
	public Fatura listarFaturasParaPagamento(Pers_Imoveis imoveis) throws Exception {
